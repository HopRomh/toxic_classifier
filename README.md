...
> Проект использует PyTorch с CUDA-зависимостями (обучение проводилось на GPU). Для CPU-инференса рекомендуется отдельно поставить CPU-версию torch согласно [official guide](https://pytorch.org/get-started/locally/) перед установкой остальных зависимостей.
